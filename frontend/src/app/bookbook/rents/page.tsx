...
export default function BookRentPage() {
     ...
     * @param e 파일 입력 필드 이벤트 (TypeScript 타입 명시)
     */
    ...
    /**
     * 폼 제출 처리: 기본 동작 방지 및 데이터 콘솔 출력.
     * 실제로는 백엔드 API (POST /rent)로 데이터 전송.
     * @param e 폼 제출 이벤트 (TypeScript 타입 명시)
     */
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        alert('책 등록 정보가 콘솔에 출력되었습니다!'); // 임시 알림
    };
