...
// // RentCreateRequestDTO와 유사하지만, DB에서 조회될 때의 필드를 반영합니다.
...
//     const { id } = params; // Next.js 동적 라우팅으로 URL에서 'id' 값을 가져옴
...
//     const displayImageUrl = bookDetail.bookImage || defaultCoverImageUrl; // 이미지가 없으면 기본 이미지 표시
...
//                         {bookDetail.title}
//                     </h1>
//                     {bookDetail.createdAt && ( // 등록일이 있다면 표시
//                         <p className="text-sm text-gray-500">
//                             {bookDetail.createdAt.split('T')[0].replace(/-/g, '/')} {/* YYYY/MM/DD 형식으로 표시 */}
//                         </p>
//                     )}
//                 </div>
...
//                             className="w-48 h-auto object-cover rounded-lg shadow-md max-w-full"
//                             style={{ maxHeight: '320px' }} // 이미지 높이 제한
//                             onError={(e) => {
//                                 e.currentTarget.src = defaultCoverImageUrl; // 이미지 로드 실패 시 대체 이미지
...
//                                 <span className="font-semibold text-gray-600">책 제목:</span> {bookDetail.bookTitle}
//                             </p>
//                             <p className="text-gray-700">
//                                 <span className="font-semibold text-gray-600">저자:</span> {bookDetail.author}
//                             </p>
//                             <p className="text-gray-700">
//                                 <span className="font-semibold text-gray-600">출판사:</span> {bookDetail.publisher}
//                             </p>
//                             <p className="text-gray-700">
//                                 <span className="font-semibold text-gray-600">카테고리:</span> {bookDetail.category}
//                             </p>
//                             <p className="text-gray-700">
//                                 <span className="font-semibold text-gray-600">책 상태:</span> {bookDetail.bookCondition}
//                             </p>
//                         </div>
//                         {/* 수정하기/대여하기/북마크 버튼 영역 (현재는 껍데기만) */}
...
//                                 </button>
//                             </div>
//                             <div className="flex items-center space-x-2 text-gray-600 text-sm italic mt-2">
...
//                                 사용자에 따라 버튼이 다르게 보입니다.
//                                 <br />
//                                 <span className="font-semibold">→ 수정하기 or 대여하기</span>
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
//                     <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
//                         <p className="text-gray-800 leading-relaxed whitespace-pre-wrap">
//                             {bookDetail.description || "이 책에 대한 상세 설명이 없습니다."}
//                         </p>
//                     </div>
//                 </div>
...
// src/app/bookbook/rent/preview/page.tsx
"use client";
